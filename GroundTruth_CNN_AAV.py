...
def main():
    ...
    X, y, _ = get_AAV_X_y_aa(df, large_only=True, return_str=True)
    if train_full:
    ...
    CNN = CNN_ground_AAV(seq_len = X.shape[1], hidden_fc=256, hidden_conv=12, n_chars = 21)
    ...
    loss_tr, loss_te = [], []
    print("#=================================================================#")
    print("Start training for AAV dataset; model id is:", args.model_id)
